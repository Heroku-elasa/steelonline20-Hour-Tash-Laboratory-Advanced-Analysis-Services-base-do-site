...
const DashboardPage: React.FC<DashboardPageProps> = ({ setPage }) => {
    ...
    const menuItems = [
        ...
        { key: 'audit', icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" /></svg> },
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <main className="flex-1 overflow-x-hidden overflow-y-auto bg-[#f1f1f1]">
                    <div className="p-4 sm:p-8">
                        ...
                        {activeSection !== 'overview' && activeSection !== 'live' && activeSection !== 'audit' && (
