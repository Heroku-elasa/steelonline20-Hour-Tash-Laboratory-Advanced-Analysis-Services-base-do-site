...
const SiteHeader: React.FC<SiteHeaderProps> = ({ currentPage, setPage, isAuthenticated, user, onLoginClick, onLogoutClick, onSearchClick }) => {
  ...
  const SocialIcon: React.FC<{ href: string; children: React.ReactNode }> = ({ href, children }) => (
    <a href={href} target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-corp-red transition-colors">
      {children}
    </a>
  );
      ...
      <div className="bg-slate-100 border-b border-slate-200">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-10 flex items-center justify-between text-xs text-slate-600">
          <div className="flex items-center gap-4">
            <SocialIcon href="https://t.me/steelonline20">
            ...
            <SocialIcon href="https://www.instagram.com/steelonline20/">
             ...
             <SocialIcon href="https://wa.me/989122041655">
          ...
          <div className="flex items-center gap-6 font-medium">
             ...
             <a href="tel:+982122041655" className="hover:text-corp-red transition-colors font-mono dir-ltr">021-22041655</a>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center">
            <button onClick={() => setPage('home')} className="flex-shrink-0 flex items-center gap-2 group">
               <img src="/logo.png" alt="Steel Online 20" className="h-8 w-auto" />
             ...
             <div className="hidden sm:block">
                {isAuthenticated && user ? (
                    <div className="flex items-center gap-2">
                        {user.picture && <img src={user.picture} alt={user.name} title={user.name} className="h-8 w-8 rounded-full"/>}
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              {isAuthenticated && user && (
                  <div className="px-3 py-2 flex items-center gap-3 border-b border-slate-200">
                      {user.picture && <img src={user.picture} alt={user.name} className="h-10 w-10 rounded-full" />}
